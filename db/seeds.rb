...
service = Service.create!(superhero_name: "Superman", race: "Kryptonian",
 powers: "Super strength, flight, heat vision, invulnerability", fee: 5000, image_url: "https://i.pinimg.com/1200x/27/d3/a1/27d3a11cea2b9a3b2d0c41b029ec74fa.jpg", team: "Justice League", bio: "Last son of Krypton, the Man of Steel.", user: user)
...
service = Service.create!(superhero_name: "Deadpool", race: "Human mutate",
   powers: "Regenerative healing factor, skilled martial artist, breaking the fourth wall", fee: 5000, image_url: "https://i.pinimg.com/originals/e7/e7/3a/e7e73ac51c986e24d816c8612d4a304f.jpg", team: "X-Force", bio: "The Merc with a Mouth, known for his humor and combat skills.", user: user)
...
service = Service.create!(superhero_name: "Captain America", race: "Super-Soldier",
   powers: "Superhuman strength, agility, expert martial artist, vibranium shield", fee: 2000, image_url: "https://iphoneswallpapers.com/wp-content/uploads/2020/03/Captain-America-iPhone-Wallpaper.jpg", team: "Avengers", bio: "Super-soldier and symbol of justice.", user: user)
...
service = Service.create!(superhero_name: "The Deep", race: "Human",
   powers: "Aquatic adaptation, marine telepathy", fee: 3000, image_url: "https://hollywoodlife.com/wp-content/uploads/2020/09/the-boys-season-2-amazon-embed-1.jpg", team: "The Seven", bio: "Aquatic superhero with a connection to marine life.", user: user)
...
service = Service.create!(superhero_name: "Omni-Man", race: "Viltrumite",
   powers: "Super strength, flight, enhanced senses", fee: 8000, image_url: "https://i.gyazo.com/39473ef516d87a935b44dbdbd7587c5e.jpg", team: "Global Defense Agency", bio: "Powerful Viltrumite guardian.", user: user)
...
service = Service.create!(superhero_name: "Aquaman", race: "Atlantean",
   powers: "Superhuman strength, underwater breathing, control over marine life", fee: 7000, image_url: "https://i.pinimg.com/originals/a9/ba/f5/a9baf56bf22845683319b1d1b7e05f30.jpg", team: "Justice League", bio: "King of Atlantis and defender of the seas.", user: user)
...
service = Service.create!(superhero_name: "Wolverine", race: "Mutant",
   powers: "Regenerative healing, adamantium claws, enhanced senses", fee: 4000, image_url: "https://i.gyazo.com/1aa25bf63a9bc7edf5c7b72cd69d59dd.jpg", team: "X-Men", bio: "Ferocious mutant with retractable claws.", user: user)
service.photo.attach(io: file, filename: "wolverine.jpg", content_type: "image/jpg")
service.save

puts "Creating user and service [9]"
file = URI.open("https://static.wikia.nocookie.net/marvel_dc/images/e/e7/Henry_Henshaw_%28Supergirl_TV_Series%29.jpg/revision/latest/scale-to-width/360?cb=20220731203940")
...
service = Service.create!(superhero_name: "Martian Manhunter", race: "Martian",
   powers: "Shape-shifting, telepathy, super strength, flight", fee: 2500, image_url: "https://i.gyazo.com/2d49a0e3a4286d0e85791d31f4bdad5a.jpg", team: "Justice League", bio: "Last survivor of Mars, powerful telepath and shapeshifter.", user: user)
...
service = Service.create!(superhero_name: "Loki", race: "Frost Giant (adopted by Asgardians)",
 powers: "Illusions, sorcery, shape-shifting", fee: 6000, image_url: "https://i.gyazo.com/c84e955eca819ca5d7e76afdd2b0eb3d.jpg", team: "Asgardians", bio: "Trickster god with a complex history.", user: user)
...
service = Service.create!(superhero_name: "Wonder Woman", race: "Amazonian",
   powers: "Super strength, lasso of truth, indestructible bracelets", fee: 5000, image_url: "https://static.wikia.nocookie.net/dccu/images/6/6f/JL_Wonder_Woman.jpg/revision/latest?cb=20160914003449", team: "Justice League", bio: "Warrior princess and champion of justice.", user: user)
service.photo.attach(io: file, filename: "wonder_woman.jpg", content_type: "image/jpg")
service.save

puts "Creating user and service [12]"
file = URI.open("https://i.gyazo.com/d44c7c3a8125dd15a45f12c6fa6a07fb.png")
user = User.create!(email: "barryallen@gmail.com", password: "Flash2023", username: "Barry Allen")
user.avatar.attach(io: file, filename: "barry_allen.png", content_type: "image/png")
user.save
file = URI.open("https://i.gyazo.com/c48d6082901201564fdb2bec94f0f846.png")
service = Service.create!(superhero_name: "The Flash", race: "Human",
   powers: "Super speed, time manipulation", fee: 3000, image_url: "https://i.gyazo.com/c48d6082901201564fdb2bec94f0f846.png", team: "Justice League", bio: "Scarlet Speedster and master of the Speed Force.", user: user)
...
user.save
file = URI.open("https://i.gyazo.com/11ea124028b16a15e9e590c22f08036a.jpg")
service = Service.create!(superhero_name: "Spider-Man", race: "Human",
   powers: "Superhuman agility, web-slinging, wall-crawling, spider-sense", fee: 5000, image_url: "https://i.gyazo.com/11ea124028b16a15e9e590c22f08036a.jpg", team: "Spider Family", bio: "Friendly neighborhood web-slinger.", user: user)
...
user.save
file = URI.open("https://i.gyazo.com/51cb90e5c2def8e9647cb5a1e9570a4c.jpg")
service = Service.create!(superhero_name: "Star-Lord", race: "Human",
   powers: "Masterful pilot, tactical skills, elemental gun", fee: 4000, image_url: "https://i.gyazo.com/51cb90e5c2def8e9647cb5a1e9570a4c.jpg", team: "Guardians of the Galaxy", bio: "Legendary outlaw and leader of the Guardians.", user: user)
...
user.save
file = URI.open("https://i.gyazo.com/f346a3646aaf7bc34734bd6edd5df9a1.jpg")
service = Service.create!(superhero_name: "Starlight", race: "Human",
   powers: "Light manipulation, flight, energy projection", fee: 3000, image_url: "https://i.gyazo.com/f346a3646aaf7bc34734bd6edd5df9a1.jpg", team: "The Seven", bio: "Bright and optimistic superhero in The Seven.", user: user)
...
service = Service.create!(superhero_name: "Captain Marvel", race: "Human/Kree",
   powers: "Superhuman strength, energy absorption, flight", fee: 6000, image_url: "https://static.wikia.nocookie.net/marvel-cinematic-universe/images/1/10/06captain-marvel1.jpg/revision/latest?cb=20191003151550", team: "The Avengers", bio: "Powerful hero with cosmic abilities.", user: user)
